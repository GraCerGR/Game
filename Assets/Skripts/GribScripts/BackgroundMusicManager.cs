...
public class BackgroundMusicManager : MonoBehaviour
{
    ...
    private void Start()
    {
        if (mainAudioSource != null && calmMusic != null)
        {
            ...
            mainAudioSource.volume = 1f * volume;
    ...
    private IEnumerator CrossfadeToMusic(AudioClip newClip)
    {
        ...
        while (time < crossfadeDuration)
        {
            ...
            mainAudioSource.volume = Mathf.Lerp(1f * volume, 0f, t);
            secondaryAudioSource.volume = Mathf.Lerp(0f, 1f * volume, t);
            time += Time.deltaTime;
            yield return null;
        }
        ...
        secondaryAudioSource.volume = 1f * volume;
        mainAudioSource.volume = 1f * volume;
    }
}
